# This script was used to generate Graphs/split_canonicity.png

"""
Script for generating a scatter plot showing the relationship between step count and log-likelihood,
...
if "Step Count" in df.columns and "Canonical?" in df.columns:
    ...
    # Split data based on canonicity
    ...
    # -------------------------------
    # Perform linear regression for non-canonical data
    ...
    # Perform linear regression for canonical data
