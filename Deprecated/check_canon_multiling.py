...
some_non_canonical_tokens = torch.tensor([252], device='cuda:0')
some_canonical_tokens = torch.tensor([4210], device='cuda:0')
...
actual_tokens = torch.tensor([38130, 47379, 24918, 13727, 40158, 12070, 37856, 35066, 15624, 22698,
        ...
        14575, 24438], device='cuda:0')

last_token = torch.tensor([24438], device='cuda:0')
