...
data = {
    ...
    'Canonical': [-623.7204314, -1412.640661, -1814.961775, -1966.654943, -2930.863195, -2921.253464, -3372.210656],
...
# Set x-ticks to only show the token counts that correspond to data points
ax1.set_xticks(data['Token Count'])

# Create a secondary x-axis for Step Count
ax2 = ax1.twiny()
